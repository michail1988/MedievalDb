...
INSERT INTO MED_USERS_H (FK_USER, NAME, SURNAME, EMAIL, PASSWORD, REGISTERDATE, UNIVERSITY, PHONE, CONGRESSROLE, SUBJECTDESCRIPTION, CONTACTCOMMENTS, CONFIRMATION, PRIVILEGES, SUMMARY, ABSTRACT, PAPER_ACCEPTATION, PAYMENT, PAYMENT_ACCEPTED, ACADEMIC_TITLE, FK_EDITOR, MODIFIED_DATE)
  VALUES(NEW.ID, NEW.NAME, NEW.SURNAME, NEW.EMAIL, NEW.PASSWORD, NEW.REGISTERDATE, NEW.UNIVERSITY, NEW.PHONE, NEW.CONGRESSROLE, NEW.SUBJECTDESCRIPTION, NEW.CONTACTCOMMENTS, NEW.CONFIRMATION, NEW.PRIVILEGES, NEW.SUMMARY, NEW.ABSTRACT, NEW.PAPER_ACCEPTATION, NEW.PAYMENT, NEW.PAYMENT_ACCEPTED, NEW.ACADEMIC_TITLE, NEW.FK_EDITOR, NOW());
